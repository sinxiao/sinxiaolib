...
public class SystemBarTintManager {
    ...
    private void setupStatusBarView(Context context, ViewGroup decorViewGroup) {
        ...
        FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(FrameLayout.LayoutParams.MATCH_PARENT, this.mConfig.getStatusBarHeight());
        params.gravity = 48;
    ...
    private void setupNavBarView(Context context, ViewGroup decorViewGroup) {
        ...
        if (this.mConfig.isNavigationAtBottom()) {
            params = new FrameLayout.LayoutParams(FrameLayout.LayoutParams.MATCH_PARENT, this.mConfig.getNavigationBarHeight());
            params.gravity = 80;
        } else {
            params = new FrameLayout.LayoutParams(this.mConfig.getNavigationBarWidth(), FrameLayout.LayoutParams.MATCH_PARENT);
            params.gravity = 5;
        }
